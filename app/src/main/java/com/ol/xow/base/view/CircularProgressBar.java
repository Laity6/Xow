...
public class CircularProgressBar extends View {
    ...
    private int mBackgroundColor = Color.parseColor("#407fbb");
    private int mPrimaryColor = Color.parseColor("#ef8300");
    private float mStrokeWidth = DensityUtil.dip2px(getContext(),4f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int colors[] = {Color.parseColor("#ef8300"), Color.parseColor("#E67405")};
        canvas.drawCircle(halfWidth, halfHeight, radius - halfStrokeWidth, mPaint);
        SweepGradient gradient = new SweepGradient(360, 360, colors, null);
